        ...
        (set, get) => ({
            ...
            deleteNode: (id) =>
                set((state) => {
                    ...
                    const clearSelection = state.selectedNodeId === id || (state.selectedFile && state.selectedFile.id === id);
            ...
            renameNode: (id, name) => set((state) => ({ tree: mapNode(state.tree, id, (n) => ({ ...n, name })) })),
        }),
        {
            name: 'file-store',
